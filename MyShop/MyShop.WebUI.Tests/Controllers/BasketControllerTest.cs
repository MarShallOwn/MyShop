...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        [TestMethod]
        public void CantCheckOutAndCreateOrder()
        {
            IRepository<Product> products = new MockContext<Product>();
            products.Insert(new Product() {Id = "1",Price = 10.00m } );
            products.Insert(new Product() {Id = "2", Price = 5.00m } );
            ...
            customers.Insert(new Customer() { Id = "1", Email = "marwansamih15@gmail.com",ZipCode = "21500" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("marwansamih15@mgail.com", "Forms"), null);
